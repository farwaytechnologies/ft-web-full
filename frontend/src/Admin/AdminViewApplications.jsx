            ...
            <tbody>
              {applications.map((app) => (
                <tr key={app._id}>
                  ...
                  <td>
                    <div><a href={app.portfolio} target="_blank" rel="noopener noreferrer">Portfolio</a></div>
                    <div><a href={app.linkedinProfile} target="_blank" rel="noopener noreferrer">LinkedIn</a></div>
                  </td>
                  <td>
